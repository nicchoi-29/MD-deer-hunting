...
4. I wanted to provide more commentary on the data, but I wasn't sure what to say without repeating information that was already displayed on the visuals and without implying causation. For my next project, I'd like to practice providing more commentary that complements each visual. I'd also like to use a scrollytelling template. 