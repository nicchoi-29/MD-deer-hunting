...
2. Related, I was interested in showing the change in Lyme incidence rates by county in Maryland on a changing map. I didn't want to make 10 maps though, and I had difficulty getting my incidence rate values to show up on a choropleth map while also displaying county names. I think I would've had to use a different base map, which would've created a longer and more involved workflow.   